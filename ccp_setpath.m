...
%default paths 
%--------------------------------------------------------------------------
CCPpath = '/Volumes/WD2T/Tools/CCP';
addpath(genpath(CCPpath));
...
%--------------------------------------------------------------------------
spmver = 12;
SPMpath = '/Volumes/WD2T/Tools/spm12';
...
%%  remove toolboxes that interfere with matlab functions or other tools 
% -fieldtrip (various matlab)
% -GraphVar (BCT/GraphicalLasso)
